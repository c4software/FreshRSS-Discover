 ...
 * same explicit end of feed, same quiet launch as List mode, as SPECS.md §4.8
 * promises. This type provides the Hilt wiring and the Immersive projection —
 * whose full-screen excerpt goes up to 1,400 characters (SPECS.md §8,
 * question 7). The visibility observation source belongs to the screen
 * ([pagerVisibility]).
 */
@HiltViewModel
